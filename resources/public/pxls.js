    ...
    const self = {
      ...
      popChatSettings() {
        ...
        const genCheckboxGroup = (label) => {
          const cb = crel('input', { type: 'checkbox', class: 'styled-checkbox' });
          const lbl = crel('label', { class: 'input-group nowrap' },
            crel('span', { class: 'label-text' }, label),
            cb,
            crel('span', { class: 'fake-checkbox onleft' }));
          return [cb, lbl];
        };
        ...
        const _selIgnores = crel('select', {
          ...
          id: 'chat-settings-ignore-select'
        },
        ...
        crel(body,
          ...
          [
            ...
            lblBanner,
            lblTemplateTitles,
            [lblFontSize, ' ', _btnFontSizeConfirm],
            lblUsernameColor,
            [lblIgnores, ' ', _btnUnignore, lblIgnoresFeedback]
          ].map(x => crel('p', x))
        );
        modal.show(modal.buildDom(
  ...
  const chromeOffsetWorkaround = (function() {
    const self = {
      ...
      elements: {
        ...
        setting: $('#setting-fix-chrome-offset-enable').parent()
      },
      init: () => {
        if (!webkitBased) {
